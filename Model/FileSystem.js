...
var FileSystem = /** @class */ (function () {
    function FileSystem() {
        this.root = new Node_1.Node("root", "", null);
        this.currentDir = this.root;
    }
    Object.defineProperty(FileSystem.prototype, "getRoot", {
        get: function () {
            return this.root;
        },
        enumerable: false,
    ...
    Object.defineProperty(FileSystem.prototype, "setRoot", {
        set: function (root) {
            this.root = root;
        },
        enumerable: false,
    ...
    Object.defineProperty(FileSystem.prototype, "getCurrentDir", {
        get: function () {
    ...
    Object.defineProperty(FileSystem.prototype, "setCurrentDir", {
    ...
    FileSystem.prototype.touch = function (name, parent) {
    ...
    FileSystem.prototype.mkdir = function (name, parent) {
        if (parent === void 0) { parent = this.currentDir; }
        if (this.currentDir.getList.search(name) === null) {
    ...
    FileSystem.prototype.cd = function (directoryName) {
    ...
    FileSystem.prototype.print = function (name) {
        if (this.currentDir.getList.search(name) === null)
            return "no such file or directory.";
        return "".concat(name, "'s data is ") + this.currentDir.getList.search(name).getContent;
    };
    FileSystem.prototype.setContent = function (name, content) {
        if (this.currentDir.getList.search(name) === null)
            return "no such file or directory.";
    ...
    FileSystem.prototype.rm = function (fileName) {
    ...
    FileSystem.prototype.mv = function (object1, object2) {
    ...
    FileSystem.prototype.cp = function (object1, object2) {
        var content;
        if (this.currentDir.getList.search(object1) === null)
            return "no such file or directory.";
        //ディレクトリ直下へのコピー
    ...
    FileSystem.prototype.treeHelper = function (node, indent) {
    ...
    FileSystem.prototype.tree = function (directoryName) {
